<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReportSms.aspx.cs" Inherits="MobiOcean.MDM.Web.ReportSms1" %>
            ...
            <div class="bhoechie-tab-content active">
                ...
                <div class="row" style="text-align: center">
                    ...
                    <asp:Chart ID="Chart1" runat="server" BackColor="OrangeRed" Width="600px"
                        ...
                        <Titles>
                            <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 14.25pt, style=Bold" ShadowOffset="3" Text="InComing and OutGoing SMS" ForeColor="26, 59, 105"></asp:Title>
                        </Titles>
                        ...
                        <asp:GridView ID="grdmsgh" runat="server" class="table mGrid" HeaderStyle-CssClass="protable" GridLines="None" OnPageIndexChanging="grdmsgh_PageIndexChanging" AutoGenerateColumns="false" ShowHeader="true" ShowHeaderWhenEmpty="true" EmptyDataText="No record found!" PageSize="20" AllowPaging="true" OnRowDataBound="grdmsgh_RowDataBound">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Message Text">
                                    ...
                                    <%-- <EditItemTemplate>
                                                                    <asp:TextBox ID="txtContent" runat="server" Text='<%#Eval("Duration")%>' CssClass="TxtBox"></asp:TextBox>
                                                                </EditItemTemplate>--%>
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
