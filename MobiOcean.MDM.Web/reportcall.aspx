<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="reportcall.aspx.cs" Inherits="MobiOcean.MDM.Web.reportcall1" %>
                        ...
                        <asp:GridView ID="grdmsgh" runat="server" class="table mGrid" HeaderStyle-CssClass="protable" GridLines="None" OnPageIndexChanging="grdmsgh_PageIndexChanging" AutoGenerateColumns="false" ShowHeader="true" ShowHeaderWhenEmpty="true" EmptyDataText="No record found!" PageSize="20" AllowPaging="true" OnRowDataBound="grdmsgh_RowDataBound">
                            <Columns>
                                <asp:TemplateField HeaderText="Id" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblId" runat="server" Text='<%#Eval("CallLogId")%>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Phone No">
                                    <ItemTemplate>
                                        <asp:Label ID="lblNumber" runat="server" Text='<%#MyFormat(Eval("CallFrom").ToString(),Eval("CallTo").ToString(),Eval("IsIncomingCall").ToString())%>'></asp:Label>
                                ...
                                <asp:TemplateField HeaderText="Start Date Time">
                                    <ItemTemplate>
                                        <asp:Label ID="lblStartTime" runat="server" Text='<%#Convert.ToDateTime(Eval("StartTime").ToString()).ToString("dd-MMM-yyyy HH:mm:ss")%>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="End Date Time">
                                    <ItemTemplate>
                                        <asp:Label ID="lblEndTime" runat="server" Text='<%#Convert.ToDateTime(Eval("EndTime").ToString()).ToString("dd-MMM-yyyy HH:mm:ss")%>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Duration (HH:MM:SS)">
                                    <ItemTemplate>
                                        <asp:Label ID="lblContent" runat="server" Text='<%#TimeCalculate(Eval("Duration"))%>'></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Direction">
                                    <ItemTemplate>
                                        <asp:Label ID="lblDirection" runat="server" Text='<%#Eval("IsIncomingCall").ToString() == "1" ? "Incoming":"Outgoing" %>'>                                                                                                    
                                        </asp:Label>
                                    </ItemTemplate>
