...
{
    public partial class DeptReports : Base
    {
        ...
        protected void BindGrid()
        {
            ...
            srch = new AnuSearch();
            dtUser = srch.GetDeptReportDtls(ClientId, txtUser.Text.Trim());
        ...
        protected void btnsavetopdf_Click(object sender, EventArgs e)
        {
            ...
            using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
            {
                ...
                cell1 = PhraseCell(new Phrase(" Department Report ", FontFactory.GetFont("Arial", 16, Font.BOLD, BaseColor.BLACK)), PdfPCell.ALIGN_CENTER);
                cell1.Colspan = 8;
                cell1.BorderWidth = 0;
                table.AddCell(cell1);
                ...
                if (txtUser.Text != "")
                {
                    cell2 = PhraseCell(new Phrase("  Department Name : " + txtUser.Text, FontFactory.GetFont("Arial", 10, Font.BOLD, BaseColor.BLACK)), PdfPCell.ALIGN_CENTER);
                    cell2.Colspan = 8;
                    cell2.BorderWidth = 0;
                    table.AddCell(cell2);
                }
                ...
                Response.AddHeader("Content-Disposition", "attachment; filename=DepartmentReport.pdf");
                Response.ContentType = "application/pdf";
        ...
        public void GrideTable()
        {
            ...
            if (dtpdf.Rows.Count > 0)
            {
                ...
                try
                {
                    ...
                    if (txtUser.Text != "")
                    {
                        UserName = "<b> Department Name : </b>" + txtUser.Text.Trim();
                    }
                ...
                Message = Message + "<b style=' font-size: 20px;'>Department Report</b>";
                Message = Message + "</td>";
                Message = Message + "</tr>";
        ...
        protected void Send_Click(object sender, EventArgs e)
        {
            ...
            if (RbtnYou.Checked || RbtnOther.Checked)
            {
                ...
                msg.Append("<b>The below table has the details for Department.</b>");
                msg.AppendLine(); msg.AppendLine();
        ...
        private void MailsendYou(string MsgBody)
        {
            ...
            try
            {
                ...
                send.SendEmail(EmailId, "Department Report at " + GetCurrentDateTimeByUserId(), MsgBody, ClientId);
        ...
        private void MailsendOther(string MsgBody)
        {
            ...
            if (txtMailTo.Text != "" && Regex.IsMatch(txtMailTo.Text.Trim(), emailpattern))
            {
                try
                {
                    ...
                    dt = new DataTable();
                    send = new SendMailBAL();
                    send.SendEmail(txtMailTo.Text, "Department Report at " + GetCurrentDateTimeByUserId(), MsgBody, ClientId);
                    lblmsg.Text = "Mail sent successfully";
                    lblmsg.ForeColor = System.Drawing.Color.Green;
                }
                catch (Exception)
