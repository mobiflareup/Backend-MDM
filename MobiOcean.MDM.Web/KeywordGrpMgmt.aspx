<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
     CodeBehind="KeywordGrpMgmt.aspx.cs" Inherits="MobiOcean.MDM.Web.KeywordGrpMgmt" %>
                      ...
                      <%----------------- Sub admin  ----------------------- ---------------------- -------------------------------------- --------------------%>
                           ...
                           <%-- -----------------  Dropdowns ---------------------------------    -------------------------------------------------%>  
                              <%--<table class="dataTables_length"  id="datatable-editable_length">
                                  ...
                                  <%----------- Gridview ---------------------------------------------------------------------------------------------------%>
                            <asp:Label ID="Label2" runat="server" class="pull-left page-title"><h2>Keyword Group Management</h2></asp:Label>
							      <table class="table-responsive" data-pattern="priority-columns">
                                       <tr>
                                          <td >
                                           <asp:GridView ID="grdRole" runat="server" class="table table-small-font table-bordered table-striped" AutoGenerateColumns="false" ShowHeader="true" ShowHeaderWhenEmpty="true" EmptyDataText="No record found.">
                                           <Columns >
                                           ...
                                           <ItemTemplate>
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblKeywordCode" runat="server" Text='<%#Eval("GroupCode")%>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox id="txtKeywordCode" runat="server" Text='<%#Eval("GroupCode")%>' cssclass="TxtBox"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" Width="70px" />
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Group Name" >
                                            <ItemTemplate>
                                                <asp:Label ID="lblKeywordName" runat="server" Text='<%#Eval("GroupName")%>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox id="txtKeywordName" runat="server" Text='<%#Eval("GroupName")%>' cssclass="TxtBox"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" Width="100px" />
                                        </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Description" >
                                            <ItemTemplate>
                                                <asp:Label ID="lblDescription" runat="server" Text='<%#Eval("GroupDesc")%>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox id="txtDescription" runat="server" Text='<%#Eval("GroupDesc")%>' cssclass="TxtBox"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" Width="100px" />
                                        </asp:TemplateField>
