...
{
    public partial class DeviceManagement : Base
    {
        ...
        protected void grdDevice_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    Label lblIsForRooted = (Label)e.Row.FindControl("lblIsForRooted");
                    Label lblConditionApply = (Label)e.Row.FindControl("lblConditionApply");
                    Label lblFeatureName = (Label)e.Row.FindControl("lblFeatureName");
                    ...
                    if (lblIsForRooted.Text.ToLower() == "1")
                    {
                        lblConditionApply.Visible = true;
                        lblFeatureName.Attributes["style"] = "color: #d9534f;font-weight:900;";
                        lblConditionMessage.Visible = true;
                        lblConditionMessage.Attributes["style"] = "color: #d9534f;";
                    }
                }
        ...
        private void BindTimingGrid()
        {
            try
            {
                int ProfileFeatureMappingId, GroupId = 0;
