<%@ Page Title="Mobile/Sim Status" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeBehind="RemarkMobileSIM.aspx.cs" Inherits="MobiOcean.MDM.Web.RemarkMobileSIM" %>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab scrollbar" id="style-3">
        <div class="force-overflow">
            ...
            <div class="bhoechie-tab-content active div">
                ...
                <li class="profile1">&nbsp;&nbsp;Mobile/Sim Status
                ...
                <div class="table-responsive">
                    <asp:GridView ID="grdUsr" runat="server" CssClass="table mGrid" HeaderStyle-CssClass="protable" GridLines="None"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Mobile/Sim Status">
                                <HeaderStyle HorizontalAlign="center" />
                                <ItemTemplate>
                                    <asp:Label ID="lblStatus" runat="server" Text='<%#Eval("Mobile Status")%>'></asp:Label>
                                </ItemTemplate>
