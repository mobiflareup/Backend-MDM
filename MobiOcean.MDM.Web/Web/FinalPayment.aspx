<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinalPayment.aspx.cs" Inherits="Web_FinalPayment1" EnableEventValidation="false" %>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="container">
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="grdPayment" runat="server" AutoGenerateColumns="false" GridLines="None" ShowHeader="true" ShowHeaderWhenEmpty="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Price(Rs.)/Person/Day">
                                        <ItemTemplate>
                                            <asp:Label ID="lblPrice" runat="server" Text='<%#Eval("CloudPrice")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xs-12 pull-left ">
                            <div class="form-group">
                                <label for="Sms">SMS Cost* : </label>
                                <asp:TextBox ID="txtSmsCost" runat="server" placeholder="Enter Sms cost" class="form-control" Style="display: inline-block; width: 50%;"></asp:TextBox>
                                <asp:Button ID="btnAdd" CssClass="btn btn-primary" runat="server" Text="Add" OnClick="btnAdd_Click" />
                                <asp:LinkButton ID="imgedit" runat="server" OnClick="imgedit_Click" Visible="false" ToolTip="Details"><i><img src="../image/edit.png" class="iconview" Style="width:25px;height:25px;"></i></asp:LinkButton>
                                <asp:LinkButton ID="imgsave" runat="server" OnClick="imgsave_Click" Visible="false" ToolTip="Update"><i><img src="../image/save.png" /></i></asp:LinkButton>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xs-12 pull-right ">
                            <div class="form-group">
                                ...
                                <asp:LinkButton ID="lnkbtnview" runat="server" OnClick="lnkbtnview_Click" Visible="false" ToolTip="Details"><i><img src="../images/details-icon-png-24.png" class="iconview" Style="width:25px;height:25px;"></i></asp:LinkButton>
                                <asp:LinkButton ID="lnkbtnremove" runat="server" OnClick="lnkbtnremove_Click" Visible="false" ToolTip="Remove PromoCode"><i><img src="../image/Delete.png" class="iconview" Style="width:25px;height:25px;"></i></asp:LinkButton>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                        ...
                        <div class="bill-form">
                            ...
                            <div class="col-lg-6 pull-right">
                                ...
                                <form class="form-horizontal custom-form2 custom-form-lg" role="form">
                                    <div class="form-group custom-form-group">
                                        <label class="control-label custom-label col-sm-4 text-left" for="email">No of Solutions</label>
                                        <div class="col-sm-6" style="padding-top: 7px;">
                                            :&nbsp;<asp:Label ID="lblnoofsolns" runat="server" class="control-label custom-label text-left"></asp:Label>
                                        </div>
                                    </div>


                                    <div class="form-group custom-form-group">
                                        <label class="control-label custom-label col-sm-4 text-left" for="email">Duration(In Month) </label>
                                        <div class="col-sm-6" style="padding-top: 7px;">
                                            :&nbsp;<asp:Label ID="lblduration" runat="server" class="control-label custom-label text-left"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="form-group custom-form-group">
                                        <label class="control-label custom-label col-sm-4 text-left" for="email">No. Of License(S) </label>
                                        <div class="col-sm-6" style="padding-top: 7px;">
                                            :&nbsp;<asp:Label ID="lbllicense" runat="server" class="control-label custom-label text-left"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="form-group custom-form-group">
                                        <label class="control-label custom-label col-sm-4 text-left" for="email">Price(Rs.) </label>
                                        <div class="col-sm-6" style="padding-top: 7px;">
                                    ...
                                    <div class="form-group custom-form-group" id="smscost" runat="server">
                                        <label class="control-label custom-label col-sm-4 text-left" for="email">SMS Cost(Rs.) </label>
                                        <div class="col-sm-6" style="padding-top: 7px;">
                                            :&nbsp;<asp:Label ID="lblSmsCost" runat="server" class="control-label custom-label text-left" Text="0.00"></asp:Label>
                                        </div>
                                    </div>
                    ...
                    <div class="row bg-danger" style="margin-top: 15px; padding: 10px 13px; border-top: 3px solid #a9a8a8; border-radius: 5px; color: #000080; font-size: 12px;">
                        *The outgoing SMS cost will be charged on actual basis. The usage of SMS may vary as per the availability of the internet on user phone.<br />
                        *The SMS cost at present within India is Rs0.10/SMS + Service Tax.
