<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddMobileToRemote.aspx.cs" Inherits="MobiOcean.MDM.Web.AddMobileToRemote1" %>
                ...
                <div class="content padding-top-none">
                    ...
                    <div class="container whitebg padding-top-20">
                        <div class="row margin-none">
                            <div class="col-sm-12">
                                <div class="col-sm-10">
                                    <h1 class="pull-left page-title">Add Mobile To Remote Data</h1>
                                </div>
                                            ...
                                            <div class="panel-group panel-group-joined" id="accordion-test">
                                                        ...
                                                        <div class=" form">
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <label>User Name* :
                                                                        <asp:DropDownList ID="ddlUserName" AutoPostBack="true" OnSelectedIndexChanged="ddlUserName_SelectedIndexChanged" runat="server" CssClass="form-control" Width="150px" AppendDataBoundItems="true"></asp:DropDownList></label>
                                                            ...
                                                            <asp:GridView ID="grdAddMobile" runat="server" class="table-responsive table table-small-font table-bordered table-striped mGrid" AutoGenerateColumns="false" ShowHeader="true" ShowHeaderWhenEmpty="true" EmptyDataText="No record found." OnPageIndexChanging="grdAddMobile_PageIndexChanging" Width="100%" OnRowDeleting="grdAddMobile_RowDeleting"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Id" Visible="false">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblId" runat="server" Text='<%#Eval("RemoteDataId")%>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
