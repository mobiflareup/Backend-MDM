<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AppLogsDetail.aspx.cs" Inherits="MobiOcean.MDM.Web.AppLogsDetail" %>
                                ...
                                <div class="form-group ">
                                    <div class="col-lg-8">
                                        <div class="col-lg-6">
                                            <label>
                                                By Device / User Name :
                                                                   <asp:DropDownList ID="ddlUserName" runat="server" CssClass="form-control" AppendDataBoundItems="true" AutoPostBack="true" OnSelectedIndexChanged="ddlUserName_SelectedIndexChanged"></asp:DropDownList>
                                            </label>
                                        </div>
                                        <div class="col-lg-6">
                                            <label>
                                                By App Name :
                                                                     <asp:TextBox ID="SrchAppName" runat="server" CssClass="form-control"></asp:TextBox>
                                            </label>
                                        </div>
                                        <div class="col-lg-6">
                                            <label>
                            ...
                            <asp:GridView ID="grdWebsiteLogs" runat="server" CssClass="table mGrid" HeaderStyle-CssClass="protable" GridLines="None" AutoGenerateColumns="false" ShowHeader="true" ShowHeaderWhenEmpty="true" EmptyDataText="No record found!" OnPageIndexChanging="grdWebsiteLogs_PageIndexChanging" AllowPaging="true" PageSize="20">
                                <Columns>
                                    <asp:TemplateField HeaderText="S.No" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblId" runat="server" Text='<%#Eval("AppLogId")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Duration(HH:MM:SS)">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDuration" runat="server" Text='<%#TimeCalculate(Eval("Duration"))%>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" Width="120px" />
                                    </asp:TemplateField>
