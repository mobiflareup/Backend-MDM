<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeBehind="EditTempCustomer.aspx.cs" Inherits="MobiOcean.MDM.Web.EditTempCustomer" %>
                                    ...
                                    <div class=" form">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="col-md-7">
                                                    <asp:TextBox ID="txtmobile" runat="server" CssClass="form-control" placeholder="Mobile Number" MaxLength="15"></asp:TextBox>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <center>
                                                    <asp:Button ID="BtnSave" runat="server" CssClass="btn btnd btncompt waves-effect waves-light" Text="Update" ValidationGroup="save" OnClick="BtnSave_Click" />
