<%@ Page Title="Device Management" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeBehind="DeviceManagement.aspx.cs" Inherits="MobiOcean.MDM.Web.DeviceManagement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentBody" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="col-lg-12 bhoechie-tab scrollbar" id="style-3">
                <div class="force-overflow">
                    <!-- flight section -->
                    <div class="bhoechie-tab-content active">
                        <li class="profile1">Device Management</li>
                        <br />
                        ...
                        <div class="table-responsive">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Feature Name">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblIsForRooted" runat="server" Visible="false" Text='<%#Eval("IsForRooted") %>'></asp:Label>
                                            <asp:Label ID="lblConditionApply" runat="server" Text="*" Visible="false"></asp:Label>
                                        </ItemTemplate>
                            ...
                            <div id="lblConditionMessage" runat="server" visible="false">
                                <asp:Label ID="lblCMessage" runat="server" Text="* Applied only when device is <b>rooted</b>"></asp:Label>
                                <br /><br />
                            </div>
                        </div>
                        <div>
                ...
                <div class="modal-content">
                    <div class="modal-header" id="dragi">
                        ...
                        <div class="col-lg-6 col-md-6" style="text-align: right">
                            ...
                            <asp:Button ID="btnClose" runat="server" CssClass="btn btnd btncompt waves-effect waves-light" Text="Close" OnClick="btnClose_Click" Style="display: none;" />
