...
{
    public partial class AddMobileToRemote1 :Base
    {
        UserDeviceBAL udbl;
        ...
        protected void grdAddMobile_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                wipeBAL.RemoteDataId = Convert.ToInt32(((Label)gvr.FindControl("lblId")).Text.Trim());
                wipeBAL.DeleteFromRemote();
                BindGrid();
        ...
        protected void btnApply_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dt.Columns.Remove("RemoteDataId");
                wipeBAL = new WipePhoneBAL();
                wipeBAL.ClientId = ClientId;
                wipeBAL.UserId = Convert.ToInt32(ddlUserName.SelectedValue.ToString());
                wipeBAL.dt = dt;
                wipeBAL.InsertRemoteDtl();
