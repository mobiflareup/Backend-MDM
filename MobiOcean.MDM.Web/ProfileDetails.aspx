<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" 
    CodeBehind="ProfileDetails.aspx.cs" Inherits="MobiOcean.MDM.Web.ProfileDetails" %>
        ...
        <div class="force-overflow">
            ...
            <div class="bhoechie-tab-content active div">
                ...
                <div class="table-responsive">
                    <asp:GridView ID="grdUser" runat="server" DataKeyNames="ProfileId" GridLines="None" CssClass="table mGrid" HeaderStyle-CssClass="protable"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Profile Code">
                                <ItemTemplate>
                                    <asp:Label ID="lblUserCode" runat="server" Text='<%#Eval("ProfileCode").ToString()==""?"---":Eval("ProfileCode")%>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Profile Name">
                                <ItemTemplate>
                                    <asp:Label ID="lblUserName" runat="server" Text='<%#Eval("ProfileName").ToString()==""?"---":Eval("ProfileName")%>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Profile Purpose">
                                <ItemTemplate>
                                    <asp:Label ID="lblEmailId" runat="server" Text='<%#Eval("ProfilePurpose").ToString()==""?"---":Eval("ProfilePurpose")%>'></asp:Label>
                                </ItemTemplate>
