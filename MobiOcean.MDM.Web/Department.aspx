<%@ Page Title="Department" MasterPageFile="~/MasterPage.master" Language="C#" AutoEventWireup="true"
     CodeBehind="Department.aspx.cs" Inherits="MobiOcean.MDM.Web.Department" %>
                ...
                <div class="bhoechie-tab-content active">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                            <asp:GridView ID="grdDept" runat="server" AutoGenerateColumns="false" ShowHeader="false"
                                OnRowDeleting="grdDept_RowDeleting"
                                OnRowCancelingEdit="grdDept_RowCancelingEdit" OnRowEditing="grdDept_RowEditing"
                                OnRowUpdating="grdDept_RowUpdating" Width="70%" GridLines="None" ShowFooter="true">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="departmentname">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtgdv" Enabled="false" runat="server" Text='<%#Eval("DeptName")%>' CssClass="form-control"></asp:TextBox>
                                            <br />
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtgdv" runat="server" Text='<%#Eval("DeptName")%>' CssClass="form-control"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender2txtgdv" runat="server" FilterType="LowercaseLetters, UppercaseLetters,Custom,Numbers" ValidChars="()_&@#"
                                        ...
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtgdvftr" runat="server" CssClass="form-control" PlaceHolder="Department Name"></asp:TextBox>
                                            <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender2txtgdvftr" runat="server" FilterType="LowercaseLetters, UppercaseLetters,Custom,Numbers" ValidChars="()_&@#"
                               ...
                               <asp:LinkButton ID="AddButton" runat="server" OnClick="AddButton_Click" ToolTip="Add" ValidationGroup="Add">
                                ...
                                <EmptyDataTemplate>
                                    <td>
                                        <asp:TextBox ID="txtgdvftre" runat="server" CssClass="form-control" PlaceHolder="Department Name"></asp:TextBox>
