<%@ Page Title="Add Keyword" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeBehind="AddWebKeyword.aspx.cs" Inherits="MobiOcean.MDM.Web.AddWebKeyword"  %>
			...
			<div class="container whitebg padding-top-20">
				<div class="row margin-none">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="col-sm-10">
							<h1 class="pull-left page-title">Add Keyword For Web</h1>
						</div>
                                    ...
                                    ControlToValidate="txtKDesc" ErrorMessage="Required!" ForeColor="Red" ValidationGroup="save"></asp:RequiredFieldValidator>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-lg-offset-4 col-lg-6">                                                        
                                                        <asp:Button ID="btnAssign" runat="server" class="btn btn-success waves-effect waves-light" Text="Save" ValidationGroup="save"  OnClick="btnAssign_Click" />
                                                        <%--<button class="btn btn-success waves-effect waves-light" type="submit">Save</button>
                                                        <a href="admindashboard.aspx" class="btn btn-default waves-effect" type="button">Cancel</a>--%>
                                                        <asp:Button ID="btnCancel" runat="server" CssClass="btn btn-default waves-effect" Text="Cancel" CommandName="Cancel" OnClick="btnCancel_Click"/>
