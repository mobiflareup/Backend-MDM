...
{
    public partial class RemarkGPS : Base
    {
        ...
        public void BindGrid()
        {
            ...
            try
            {
                ...
                if (RoleId == 1)
                {
                    dtUser = srch.SrchMobileStatusInfo(dtClientId.SelectedValue.ToString(), txtSrchUserName.Text, txtSrchEmailId.Text, txtFrmDate.Text.Trim(), txtToDate.Text.Trim(), 16);
                }
                else
                {
                ...
                //{
                //    GPSStatus = ChkSimChange(dr["Remarks"].ToString(),Convert.ToInt32(dr["DeviceId"]));
                //    dr["Mobile Status"] = GPSStatus;
                //}
