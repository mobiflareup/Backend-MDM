<%@ Page Title="Internet Status" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeBehind="RemarkInternetConnectivity.aspx.cs" Inherits="MobiOcean.MDM.Web.RemarkInternetConnectivity" %>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab scrollbar" id="style-3">
        <div class="force-overflow">
            ...
            <div class="bhoechie-tab-content active div">
                ...
                <li class="profile1">&nbsp;&nbsp;Internet Status
                ...
                <div class="table-responsive">
                    <asp:GridView ID="grdUsr" runat="server" CssClass="table mGrid" HeaderStyle-CssClass="protable" GridLines="None"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Internet Status">
                                <HeaderStyle HorizontalAlign="center" />
                                <ItemTemplate>
