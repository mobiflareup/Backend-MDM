<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeBehind="EditArea.aspx.cs" Inherits="MobiOcean.MDM.Web.EditArea" %>
                ...
                <div class="col-lg-7 col-md-12">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-lg-8">
                            ...
                            <input type="text" id="txtLocation" class="form-control AreaLocation" placeholder="Enter a location" onkeydown="if (event.keyCode == 13) {return false;}" /> <!-- onfocus="getplaceonfocus();" onkeyup="getGeofenceLoc();" -->
                            <br />
                            
                        </div>
                    </div>
                    <div class="form-group ">
                        <label for="rad" class="control-label col-lg-4">Radius(In meter)* : </label>
                        <div class="col-lg-8">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-7" style="text-align: center">
                            ...
                            <asp:Button ID="btnC" runat="server" CssClass="btn btnd btncompt waves-effect" Text="Cancel" Visible="false" OnClick="btnC_Click" />
                        </div>
                    </div>
