...
{
    public partial class ProfileDetails : Base
    {
        ...
        {
            srch = new AnuSearch();
            dtUser = srch.GetProfileReportDtls(ClientId, txtUser.Text.Trim());
        ...
        protected void btnsavetopdf_Click(object sender, EventArgs e)
        {
            ...
            using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
            {
                ...
                cell1 = PhraseCell(new Phrase(" Profile Report ", FontFactory.GetFont("Arial", 16, Font.BOLD, BaseColor.BLACK)), PdfPCell.ALIGN_CENTER);
                cell1.Colspan = 8;
                cell1.BorderWidth = 0;
                table.AddCell(cell1);
                ...
                if (txtUser.Text != "")
                {
                    cell2 = PhraseCell(new Phrase("  Profile Name : " + txtUser.Text, FontFactory.GetFont("Arial", 10, Font.BOLD, BaseColor.BLACK)), PdfPCell.ALIGN_CENTER);
                    cell2.Colspan = 8;
                    cell2.BorderWidth = 0;
                    table.AddCell(cell2);
                }
        ...
        public void GrideTable()
        {
            ...
            if (dtpdf.Rows.Count > 0)
            {
                ...
                try
                {
                    ...
                    if (txtUser.Text != "")
                    {
                        UserName = "<b> Profile Name : </b>" + txtUser.Text.Trim();
                    }
                ...
                Message = Message + "<b style=' font-size: 20px;'>Profile Report</b>";
                Message = Message + "</td>";
                Message = Message + "</tr>";
                ...
                Message = Message + "<b>Profile Code";
                Message = Message + "</td>";
                ...
                Message = Message + "<td align='center'>";
                Message = Message + "<b>Profile Purpose";
                Message = Message + "</td>";
        ...
        protected void Send_Click(object sender, EventArgs e)
        {
            ...
            if (RbtnYou.Checked || RbtnOther.Checked)
            {
                ...
                msg.Append("<b>The below table has the details for Profile/Policy.</b>");
                msg.AppendLine(); msg.AppendLine();
        ...
        private void MailsendYou(string msgbody)
        {
            try
            {
                ...
                send.SendEmail(EmailId, "Profile Report at " + GetCurrentDateTimeByUserId(), msgbody, ClientId);
        ...
        private void MailsendOther(string msgbody)
        {
            ...
            if (txtMailTo.Text != "" && Regex.IsMatch(txtMailTo.Text.Trim(), emailpattern))
            {
                try
                {
                    ...
                    dt = new DataTable();
                    send = new SendMailBAL();
                    send.SendEmail(txtMailTo.Text, "Profile Report at " + GetCurrentDateTimeByUserId(), msgbody, ClientId);
                    lblmsg.Text = "Mail sent successfully";
                    lblmsg.ForeColor = System.Drawing.Color.Green;
                }
                catch (Exception)
