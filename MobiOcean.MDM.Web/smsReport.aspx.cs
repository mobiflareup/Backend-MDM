...
{
    public partial class smsReport : Base
    {
        DataTable dt;
        ...
        protected void btnsavetopdf_Click(object sender, EventArgs e)
        {
            ...
            using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
            {
                ...
                {
                    cell1 = PhraseCell(new Phrase(" User/Device : All ", FontFactory.GetFont("Arial", 10, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)), PdfPCell.ALIGN_CENTER);
                }
                else
                {
                    cell1 = PhraseCell(new Phrase(" User/Device : " + ddlUserName.SelectedItem.ToString(), FontFactory.GetFont("Arial", 10, iTextSharp.text.Font.BOLD, iTextSharp.text.BaseColor.BLACK)), PdfPCell.ALIGN_CENTER);
                }
                cell1.Colspan = 8;
                cell1.BorderWidth = 0;
                table.AddCell(cell1);
        ...
        public void GrideTable()
        {
            ...
            if (dtpdf.Rows.Count > 0)
            {
                ...
                try
                {
                    ...
                    if (Convert.ToInt16(ddlUserName.SelectedValue) == 0)
                    {
                        DevName = "<br/>  User/Device : All ";
                    }
                    else
                    {
                        DevName = "<br/> User/Device : " + ddlUserName.SelectedItem.ToString();
                    }
                    if (txtSrchNo.Text != "")
                    {
        ...
        protected void Send_Click(object sender, EventArgs e)
        {
            ...
            if (RbtnYou.Checked || RbtnOther.Checked)
            {
                ...
                msg.Append("<b>Please find below The User Call Report details</b>");
                msg.AppendLine(); msg.AppendLine();
