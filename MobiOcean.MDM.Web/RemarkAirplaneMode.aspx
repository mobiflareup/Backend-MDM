<%@ Page Title="Flight Mode Status" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
     CodeBehind="RemarkAirplaneMode.aspx.cs" Inherits="MobiOcean.MDM.Web.RemarkAirplaneMode" %>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab scrollbar" id="style-3">
        <div class="force-overflow">
            ...
            <div class="bhoechie-tab-content active div">
                ...
                <li class="profile1">&nbsp;&nbsp;Flight Mode Status
                ...
                <div class="table-responsive">
                    <asp:GridView ID="grdUsr" runat="server" CssClass="table mGrid" HeaderStyle-CssClass="protable" GridLines="None"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Flight Mode Status">
                                <HeaderStyle HorizontalAlign="center" />
                                <ItemTemplate>
