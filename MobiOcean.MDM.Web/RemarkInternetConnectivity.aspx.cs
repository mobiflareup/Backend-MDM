...
{
    public partial class RemarkInternetConnectivity : Base
    {
        ...
        public void BindGrid()
        {
            ...
            try
            {
                ...
                if (RoleId == 1)
                {
                    dtUser = srch.SrchMobileStatusInfo(dtClientId.SelectedValue.ToString(), txtSrchUserName.Text, txtSrchEmailId.Text, txtFrmDate.Text.Trim(), txtToDate.Text.Trim(), 15);
                }
                else
                {
                    dtUser = srch.SrchMobileStatusInfo(ClientId.ToString(), txtSrchUserName.Text, txtSrchEmailId.Text, txtFrmDate.Text.Trim(), txtToDate.Text.Trim(), 15);
                }
