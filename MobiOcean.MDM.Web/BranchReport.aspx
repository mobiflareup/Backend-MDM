<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="BranchReport.aspx.cs" Inherits="MobiOcean.MDM.Web.BranchReport1" %>
        ...
        <div class="force-overflow">
            <div class="bhoechie-tab-content active div">
                ...
                <div class="table-responsive">
                    <asp:GridView ID="grdUser" runat="server" DataKeyNames="BranchId" GridLines="None" CssClass="table mGrid" HeaderStyle-CssClass="protable"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Branch Name">
                                <ItemTemplate>
                                    <asp:Label ID="lblUserName" runat="server" Text='<%#Eval("BranchName").ToString()==""?"---":Eval("BranchName")%>'></asp:Label>
                                </ItemTemplate>
