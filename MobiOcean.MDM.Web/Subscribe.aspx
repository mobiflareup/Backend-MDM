<%@ Page Title="Subscription" Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
     CodeBehind="Subscribe.aspx.cs" Inherits="MobiOcean.MDM.Web.Subscribe" %>
    ...
    <style>
        ...
        .paddingbot_10 {
            ...
            <center>
                      ...
                      <h1 style="font-size:400%;color:#55518a"><b>Welcome to Mobiocean</b></h1>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab scrollbar" id="style-3">
        <div class="force-overflow">
            ...
            <div class="bhoechie-tab-content active div">
                ...
                <%-- <li class="profile1 hidden-sm hidden-xs">&nbsp;&nbsp;Subscription</li>
                        <li class="profile1xs hidden-lg hidden-md">&nbsp;&nbsp;Subscription</li>--%>
                    ...
                    <div class="col-sm-12">
                        <%--<div class="col-sm-5">
                            ...
                            <div class="module form-module paddingbot_10">
                                ...
                                <div class="formm">
                                    <div class="col-sm-12">
                                        <h2 style="margin: 6px; padding-top: 0px;">Enter Your Licence Key</h2>
                                        <asp:TextBox ID="freetrail" runat="server" Style="margin-bottom: 10px;" placeholder="Enter License Key"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                            ControlToValidate="freetrail" ErrorMessage="Required!" ForeColor="Red" ValidationGroup="save"></asp:RequiredFieldValidator>
                                        <asp:Button ID="btnsubmit" runat="server" ValidationGroup="save" CssClass="btn btnd btncompt waves-effect waves-light" Text="Submit" OnClick="btnAdd_Click" />
                                    </div>
                                </div>
                                <div class="clear "></div>
                            </div>
                            ...
                            <div class="module form-module paddingbot_10">
                                ...
                                <div class="formm">
                                    <div class="col-sm-12">
                                        ...
                                        <h2>Choose Subcription</h2>

                                        <a class="btn btnd btncompt waves-effect waves-light" target="_blank" href="<%=MobiOcean.MDM.BAL.Model.Constant.MobiURL%>cloud-management.php">Subscribe</a>
