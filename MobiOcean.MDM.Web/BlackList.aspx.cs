...
{
    public partial class BlackList : Base
    {
        ...
        protected void BindGrid()
        {
            try
            {
                ...
                if (RoleId == 1 || RoleId == 2)
                {
                    grdContact.DataSource = srch.SrchContactDtls(ClientId, 0, ddlUserName.SelectedValue.ToString(), syncDateTime, txtContactName.Text.Trim(), txtMobileNo.Text.Trim(), "0");
                }
                else if (RoleId == 3)
                {
                    grdContact.DataSource = srch.SrchContactDtls(ClientId, 0, ddlUserName.SelectedValue.ToString(), syncDateTime, txtContactName.Text.Trim(), txtMobileNo.Text.Trim(), "0", DeptId);
                }
                else
                {
                    grdContact.DataSource = srch.SrchContactDtls(ClientId, UserId, ddlUserName.SelectedValue.ToString(), syncDateTime, txtContactName.Text.Trim(), txtMobileNo.Text.Trim(), "0");
                }
                grdContact.DataBind();
            }
            catch (Exception)
