...
{
    public partial class Regular : Base
    {
        ...
        protected void BindGrid()
        {
            try
            {
                ...
                if (RoleId == 1 || RoleId == 2)
                {
                    grdContact.DataSource = srch.SrchContactDtls(ClientId, 0, ddlUserName.SelectedValue.ToString(), syncDateTime, txtContactName.Text.Trim(), txtMobileNo.Text.Trim(), "1");
                }
                else if (RoleId == 3)
                {
                    grdContact.DataSource = srch.SrchContactDtls(ClientId, 0, ddlUserName.SelectedValue.ToString(), syncDateTime, txtContactName.Text.Trim(), txtMobileNo.Text.Trim(), "1", DeptId);
                }
                else
                {
                    grdContact.DataSource = srch.SrchContactDtls(ClientId, UserId, ddlUserName.SelectedValue.ToString(), syncDateTime, txtContactName.Text.Trim(), txtMobileNo.Text.Trim(), "1");
                }
                grdContact.DataBind();
            }
            catch (Exception)
