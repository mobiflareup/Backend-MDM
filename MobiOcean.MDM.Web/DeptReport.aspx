<%@ Page Title="Department Report" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeBehind="DeptReport.aspx.cs" Inherits="MobiOcean.MDM.Web.DeptReports" %>
        ...
        <div class="force-overflow">
            <div class="bhoechie-tab-content active div">
                ...
                <div class="table-responsive">
                    <asp:GridView ID="grdUser" runat="server" DataKeyNames="DeptId" GridLines="None" CssClass="table mGrid" HeaderStyle-CssClass="protable"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Department Name">
                                <ItemTemplate>
                                    <asp:Label ID="lblUserName" runat="server" Text='<%#Eval("DeptName").ToString()==""?"---":Eval("DeptName")%>'></asp:Label>
                                </ItemTemplate>
